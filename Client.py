...
if __name__ == '__main__':
    ...
    #Array of message sentences to pig-latinize by sending to server
    ...
    #send each message sentence to the server and print each pig latin
    #response
    ...
    for msg_S in msg_L:
        ...
        msg_S = None
        while msg_S == None:
            msg_S, seq_num = rdt.rdt_2_1_receive()
            if msg_S is None:
